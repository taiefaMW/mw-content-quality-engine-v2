    ...
    <div className="min-h-screen flex flex-col relative">
      ...
      <div className="container max-w-6xl mx-auto px-4 flex-1 relative z-10">
        ...
        <main className="py-6 md:py-10">
          {/* Input Section */}
          <div className="bg-card rounded-xl p-5 md:p-6 shadow-[0_8px_20px_-4px_rgba(0,0,0,0.12)] mb-8">
          ...
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-8">
            ...
            <div className="space-y-6 flex flex-col order-1 lg:order-1">
              {/* Score Dial - Hero */}
              <div className="bg-card rounded-xl p-6 md:p-8 shadow-[0_8px_20px_-4px_rgba(0,0,0,0.12)] flex flex-col items-center">
              ...
              <div className="bg-card rounded-xl p-5 md:p-6 shadow-[0_8px_20px_-4px_rgba(0,0,0,0.12)] flex-1 order-3 lg:order-2">
            ...
            <div className="bg-card rounded-xl p-5 md:p-6 shadow-[0_8px_20px_-4px_rgba(0,0,0,0.12)] lg:self-stretch flex flex-col order-2 lg:order-2">
