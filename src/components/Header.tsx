  ...
  return (
    <header className="flex flex-col items-center py-8 space-y-3 relative">
      ...
      <h1 
        ...
        style={{ color: isBlueMode ? '#ffffff' : '#003edb' }}
      >
        Content <span className="relative inline-block">Quality<img src={underline} alt="" className="absolute left-0 -bottom-1 w-full h-auto pointer-events-none" /></span> Engine
      </h1>
      <p 
